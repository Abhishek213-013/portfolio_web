                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="mt-2 flex flex-wrap gap-2">
                                <span class="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded">bi bi-emoji-smile</span>
                                <span class="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded">fas fa-users</span>
                                <span class="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded">bi bi-award</span>
                                <span class="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded">fas fa-code</span>
                            </div>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Use Bootstrap Icons (bi-*) or Font Awesome (fas-*) class names</p>
                        </div>
            ...
            <div v-else-if="!initialLoading || statisticsList.length > 0" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <draggable 
                        ...
                        handle=".drag-handle"
                        v-if="Array.isArray(statisticsList)"
                    >
                            ...
                            <div :class="[
                                ...
                                <div class="mb-4">
                                    <div :class="[
                                        ...
                                        <i :class="[stat.icon, getColorClass(stat.color, 'text'), 'text-2xl']"></i>
                                    </div>
                                    <div :class="[
...
const colorOptions = [
    { value: 'blue', label: 'Blue', bgColor: 'bg-blue-500', textColor: 'text-blue-600 dark:text-blue-400' },
    { value: 'green', label: 'Green', bgColor: 'bg-green-500', textColor: 'text-green-600 dark:text-green-400' },
    { value: 'yellow', label: 'Yellow', bgColor: 'bg-yellow-500', textColor: 'text-yellow-600 dark:text-yellow-400' },
    { value: 'red', label: 'Red', bgColor: 'bg-red-500', textColor: 'text-red-600 dark:text-red-400' },
    { value: 'purple', label: 'Purple', bgColor: 'bg-purple-500', textColor: 'text-purple-600 dark:text-purple-400' },
    { value: 'indigo', label: 'Indigo', bgColor: 'bg-indigo-500', textColor: 'text-indigo-600 dark:text-indigo-400' },
];
...
const fetchStatistics = async () => {
    try {
        ...
        console.log('Fetched statistics:', statisticsList.value);
        ...
        if (router.page.props && router.page.props.flash) {
            router.page.props.flash.error = 'Failed to load statistics. Please try again.';
        }
    } finally {
...
const deleteStatistic = async (id) => {
    ...
    try {
        ...
        router.visit(window.location.pathname, {
            ...
            onSuccess: () => {
                if (router.page.props && router.page.props.flash) {
                    router.page.props.flash.success = 'Statistic deleted successfully!';
                }
            }
        });
